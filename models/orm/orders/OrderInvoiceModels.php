<?php
	 ...
	 * Time: 09:03
	 */
	class OrderInvoiceModels extends Database
	{
		protected $pdo;
		...
		public function __construct($id = false)
		{
			...
			if ($id) {
				Autoloader::hydrate($this, 'OrderInvoice', $id);
			}
		}
		
		public function getOrderInvoiceById($id){
		...
		/**
		 * @param mixed $id_order_invoice
		 */
		public function setIdOrderInvoice($id_order_invoice)
		{
		...
		public function upd(){
			$update = $this->update->update($this->table)
									...
									->where($this->id.' = "'.$this->id_order_invoice.'"');
								
			return $this->pdo->exec('mysql', $update);
		}
		
		public function delete(){
			$delete = $this->delete->delete($this->table.' WHERE '.$this->id.' = "'.$this->id_order_invoice.'"');
